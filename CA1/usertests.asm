    ...
    3998:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a06:	50                   	push   %eax
    3a07:	56                   	push   %esi
    3a08:	e8 f6 fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a39:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
    ...
    3a70:	50                   	push   %eax
    3a71:	57                   	push   %edi
    3a72:	e8 8c fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3ad0:	57                   	push   %edi
    3ad1:	e8 2d fe ff ff       	call   3903 <write>
    ...
    3ae1:	52                   	push   %edx
    3ae2:	57                   	push   %edi
    3ae3:	e8 1b fe ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b4b:	53                   	push   %ebx
    3b4c:	57                   	push   %edi
    3b4d:	e8 b1 fd ff ff       	call   3903 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3b8a:	52                   	push   %edx
    3b8b:	57                   	push   %edi
    3b8c:	e8 72 fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3ca6:	56                   	push   %esi
    3ca7:	e8 bf fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
